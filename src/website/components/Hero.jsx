  ...
  return (
    <section className="container mx-auto flex flex-col lg:flex-row items-center justify-between pt-16 lg:pt-8 border-b-4 border-menu/75">
      <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start  text-center lg:text-right mb-8 lg:mb-0 lg:mt-0 mr-2 m-auto ">
        ...
        <div className="relative mt-6 flex flex-col lg:flex-row items-center  justify-center lg:justify-start w-4/5">
          <input
            ...
            className="border border-gray-300 p-2 lg:p-4 rounded-md w-full lg:mr-4 mb-2 lg:mb-4 lg:mb-0 stroke-menu"
          />
          <button className="lg:absolute bg-menu lg:left-2 lg:top-1 lg:top-2 text-white text-sm md:text-md  px-8 lg:px-6 py-1 py-3 rounded-md hover:bg-main">
            ابدأ الآن
          </button>
        </div>
        ...
        <div className="mt-8 flex justify-start md:justify-start w-2/3">
          <div className="text-center md:text-right">
            ...
            <p className="text-gray-400 text-xs ">أكثر من 500 شركة مدعومة من خلالنا</p>
          </div>
      ...
      <div className="md:w-1/2 flex justify-center relative">
        ...
        />
        <div className="animate-bounce  absolute lg:flex flex justify-between items-center top-10 left-[-2.5rem] lg:left-10 bg-white p-2 rounded-lg shadow-lg w-32 lg:w-52">
